  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (targetScope === 'departments') {
        ...
        setStatusFeedback({
          type: 'success',
          message: `Scheduled, assigned & emailed ${count} oral defense invitation(s) for Department ${dept?.name || ''}!`,
        });
      ...
      if (targetScope === 'subjects') {
        ...
        setStatusFeedback({
          type: 'success',
          message: `Scheduled, assigned & emailed ${count} oral defense invitation(s) for Subject ${subj?.name || ''}!`,
        });
      ...
      if (targetScope === 'programs') {
        ...
        setStatusFeedback({
          type: 'success',
          message: `Scheduled, assigned & emailed ${count} interview invitation(s) for ${prog?.name || ''}!`,
        });
    ...
    <div className="fixed inset-0 z-[9999] w-screen h-screen min-h-screen bg-black/75 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white dark:bg-accent-900 border border-accent-200 dark:border-accent-800 rounded-2xl max-w-4xl w-full max-h-[92vh] flex flex-col shadow-2xl overflow-hidden my-auto animate-scale-in">
        ...
        {scheduledInterviewResult ? (
          ...
          {/* 3. Pre-Interview Oral Defense Questions & Rubric Builder */}
