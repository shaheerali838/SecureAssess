...
export function AppShell({
  ...
  const orgNav = [
    ...
    { label: t('structure') || 'Academic Structure', icon: <GraduationCap size={18} />, id: 'org-academic-structure' },
    { label: 'Assessments', icon: <FileText size={18} />, id: 'org-assessments' },
    ...
    { label: 'Candidates', icon: <Users size={18} />, id: 'org-participants' },
    { label: 'Evaluation Rubrics', icon: <CheckSquare size={18} />, id: 'org-rubrics' },
    { label: 'Live Proctoring', icon: <ShieldCheck size={18} />, id: 'org-integrity' },
    { label: 'Exam Sessions', icon: <Activity size={18} />, id: 'org-sessions' },
