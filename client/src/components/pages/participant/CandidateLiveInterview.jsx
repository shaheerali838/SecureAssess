      ...
      try {
        ...
        if (current) {
          ...
          if (current.status === 'COMPLETED' || current.status === 'CANCELLED') {
            ...
            setSessionEndedReason('This interview defense session has already been concluded by the examiner.');
          }

          if (localStorage.getItem('secureassess_access_token')) {
            try {
            ...
            <div className="lg:col-span-6 space-y-6">
              <div className="p-6 rounded-3xl bg-gradient-to-br from-accent-900 to-emerald-950/30 border border-emerald-500/20 shadow-2xl relative overflow-hidden">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h2 className="text-lg font-bold text-white">Waiting for Examiner to Enter Room</h2>
                    <p className="text-xs text-accent-400">You are in queue for: <span className="text-accent-200">{interviewTitle}</span></p>
                  </div>
                </div>
                ...
                <div className="pt-4 mt-3 border-t border-accent-800/80 flex items-center justify-between">
                  <div className="flex items-center gap-2 text-xs text-amber-400 font-medium">
                    ...
                    <span>Locked until examiner arrives</span>
                  </div>
